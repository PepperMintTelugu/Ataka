...
import { ordersAPI } from "@/lib/api-appwrite";
...
export default function PaymentsManager() {
  ...
  const loadPayments = async () => {
    try {
      setLoading(true);
      const orders = await ordersAPI.getAllOrders(); // Get orders which include payment info
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <div>
                            <p className="text-sm font-medium capitalize">
                              {(payment.paymentMethod || "razorpay").replace(
                                "_",
                                " ",
                              )}
                            </p>
                  ...
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="capitalize">
                        {(selectedPayment.paymentMethod || "razorpay").replace(
                          "_",
                          " ",
                        )}
                      </span>
