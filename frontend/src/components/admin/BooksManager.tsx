...
import { booksAPI } from "@/lib/api-appwrite";
...
const mockBooks: Book[] = [
  {
    ...
    publisherTelugu: "విశ్వకర్మ ప��్లికేషన్స్",
    category: "Literature",
    price: 450,
    originalPrice: 500,
  ...
  },
  {
    ...
    images: [
      "https://via.placeholder.com/400x600/8b5cf6/white?text=��న్యాశుల��కం",
    ],
    inStock: true,
    stockQuantity: 18,
    rating: 4.6,
  ...
  },
  {
    ...
    descriptionTelugu:
      "భారతీయ సమాజంలో సంప్రదాయ మరియు ఆధునిక విలువల ��ధ్య వైరుధ్యాలను హాస్యభ���ితంగా చిత్రీకరించిన వ్య��గ్య నవల.",
    coverImage:
      "https://via.placeholder.com/400x600/f59e0b/white?text=బా��ిస్టర్+పార్వతీశం",
    images: [
      "https://via.placeholder.com/400x600/f59e0b/white?text=బారిస్టర్+పార్వతీ��ం",
    ],
    inStock: true,
    stockQuantity: 15,
    rating: 4.7,
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredBooks.map((book, index) => (
                    <tr
                      key={book.id || book.$id || `book-${index}`}
